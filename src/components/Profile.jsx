                                    ...
                                    <div>
                                        ...
                                        {userData.linkedin && (
                                            <p className="flex items-center gap-2 mb-1 text-gray-600">
                                                ...
                                                <a href={userData.linkedin} target="_blank" rel="noopener noreferrer" className="hover:underline">
                                    ...
                                    <div>
                                        ...
                                        {userData.github && (
                                            <p className="flex items-center gap-2 mb-1 text-gray-600">
                                                ...
                                                <a href={userData.github} target="_blank" rel="noopener noreferrer" className="hover:underline">
